...
class BinancePriceStream:
    def __init__(self, pairs: List[str], on_message: Callable[[dict], None]):
        ...
        # Rate limiting
        self.rate_limiter = asyncio.Semaphore(1200)  # Binance limit
        ...
        # Data validation
        self.last_prices = {}
        self.price_change_threshold = 0.1  # 10% price change alert
        ...
        while self.reconnect_attempts < self.max_reconnects:
            try:
                ...
                async with websockets.connect(
                    ...
                    # Send subscription message for multiple streams
    ...
    async def _subscribe_to_streams(self, ws):
        ...
        # Subscribe to trade streams for real-time prices
        trade_subscription = {
            "method": "SUBSCRIBE", 
    ...
    async def _handle_reconnection(self):
        ...
        wait_time = min(300, 2 ** self.reconnect_attempts)  # Max 5 minutes
