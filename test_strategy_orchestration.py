    ...
    async def _generate_signal(self):
        ...
        try:
            ...
            signal = StrategySignal(
                ...
                holding_period=random.randint(15, 240),  # 15 minutes to 4 hours
                metadata={
...
class StrategyOrchestrationTester:
    ...
    def __init__(self):
        self.orchestrator = StrategyOrchestrationEngine(
            ...
            max_strategies=8,
            rebalance_frequency=120  # 2 minutes for testing
        )
    ...
    def analyze_orchestration_results(self):
        ...
        for insight in self.meta_insights[-3:]:  # Last 3 insights
