...
class PortfolioManagementTester:
    ...
    async def simulate_trading_activity(self):
        ...
        trades = [
            ...
            # Price movements and additional trades
        ...
        # Execute trades with realistic timing
    ...
    async def simulate_market_movements(self):
        ...
        for day in range(50):
            ...
            for symbol, base_price in prices.items():
                ...
                daily_return = random.gauss(0, 0.03)  # 3% daily volatility
                
                # Add some trend
                if day < 25:
                    daily_return += 0.001  # Slight uptrend
                else:
                    daily_return -= 0.0005  # Slight downtrend
    ...
    async def test_risk_monitoring(self):
        ...
        # Simulate a large drawdown to trigger alerts
        crash_prices = {}
        ...
        for symbol in current_positions:
            ...
            crash_prices[symbol] = current_price * 0.7  # 30% crash
        ...
        for symbol in current_positions:
            current_price = self.portfolio_engine.positions[symbol].current_price
            recovery_prices[symbol] = current_price * 1.15  # 15% recovery
    ...
    def analyze_performance(self):
        ...
        for alert in self.received_alerts[-3:]:  # Last 3 alerts
